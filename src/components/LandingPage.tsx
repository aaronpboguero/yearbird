  ...
  return (
    <div className="landing-bg relative min-h-screen w-screen overflow-hidden text-zinc-950">
      ...
      <nav className="absolute right-4 top-4 z-20 flex items-center gap-3 sm:right-6 sm:top-6">
        <a
          href="/privacy.html"
          className="rounded-full px-3 py-2 text-sm font-medium text-zinc-500 transition hover:bg-white/50 hover:text-zinc-700"
        >
          Privacy
        </a>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="rounded-full p-2 text-zinc-400 transition hover:bg-white/50 hover:text-zinc-600"
